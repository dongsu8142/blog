...
import { MessageSquare, Heart } from "lucide-preact";
...
const generateDummyPosts = (count: number, startIndex: number = 0) => {
  return Array.from({ length: count }, (_, i) => ({
    ...
    description: "This is a short description of the blog post. It gives a brief overview of what the post is about.",
    author: {
      name: "John Doe",
...
export const BlogPosts = () => {
  ...
  return (
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {posts.map(post => (
        <div key={post.id} class="bg-white rounded-lg shadow-md overflow-hidden">
